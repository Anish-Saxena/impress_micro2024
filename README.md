...
We recommend creating a `conda` environment and installing the required dependencies, as shown below:

1. `conda create -n plotting python=3.9`
2. `conda activate plotting`
3. `pip install matplotlib numpy seaborn`
4. `jupyter-notebook impress_graphs.ipynb`
