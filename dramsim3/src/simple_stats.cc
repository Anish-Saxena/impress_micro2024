...
SimpleStats::SimpleStats(const Config& config, int channel_id)
    ...
    //Impress
    InitStat("num_express_pre_cmds", "counter", "Number of express PRE commands");
    InitStat("num_rfm_cmds", "counter", "Number of RFM commands");
    InitStat("num_rhmit_delay", "counter", "Number of delayed RH mitigations");
    InitStat("sum_rhmit_delay", "counter", "Sum of RH mitigations delays");
    InitStat("num_rhmits", "counter", "Number of RH mitigations");
