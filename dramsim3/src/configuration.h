...
class Config {
   public:
    ...
    float rowbuf_hitrate_th; // Impress adaptive page policy
    bool adaptive_page_policy; // Impress page policy
    bool impress_d_enable;
    bool impress_p_enable;
    uint64_t mop_gang_size;
    uint32_t app_psel_max;
    uint32_t app_psel_inc;
