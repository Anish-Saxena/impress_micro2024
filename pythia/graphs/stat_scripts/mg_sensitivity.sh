...
CURR_DIR=`pwd`
OUT_FILE="${CURR_DIR}/data/mg_sensitivity_10M.csv"

cd ${STAT_DIR}/;

suite1_DIR="T4K/mg_drfm/36ns/"
suite2_DIR="T4K/mg_drfm/66ns/"
suite3_DIR="T4K/mg_drfm/96ns/"
suite4_DIR="T4K/mg_drfm/186ns/"
suite5_DIR="T4K/mg_drfm/336ns/"
suite6_DIR="T4K/mg_drfm/636ns/"
suite7_DIR="T4K/mg_drfm/no_mro/"
