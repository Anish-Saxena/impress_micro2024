...
CURR_DIR=`pwd`
OUT_FILE="${CURR_DIR}/data/para_sensitivity_mop_gs8_$1.csv"

cd ${STAT_DIR}/;

suite1_DIR="$1/para_drfm/36ns/"
suite2_DIR="$1/para_drfm/66ns/"
suite3_DIR="$1/para_drfm/96ns/"
suite4_DIR="$1/para_drfm/186ns/"
suite5_DIR="$1/para_drfm/336ns/"
suite6_DIR="$1/para_drfm/636ns/"
suite7_DIR="$1/para_drfm/no_mro/"
